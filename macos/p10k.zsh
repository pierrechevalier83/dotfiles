# Generated by Powerlevel10k configuration wizard on 2019-08-15 at 12:57 BST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 27551.
...
() {
  ...
  # Prevent the icon from overlapping on the number by adding a space
